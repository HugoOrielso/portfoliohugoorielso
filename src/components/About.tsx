                  ...
                  <BlurFade delay={0.25} inView>
                    {language === 'english' && 
                      <p className='dark:text-zinc-200 text-zinc-900 text-xs block w-full sm:text-base my-2 duration-300 text-balance'>
                        <span className='text-yellow-500 font-bold'>Full Stack Developer</span> with <span className='text-yellow-500 font-bold'>+2 years</span> of experience in creating web applications and APIs using <span className='text-yellow-300'>Node.js</span>  and <span className='text-yellow-300'>React.js</span> .I have experience in creating REST applications, managing relational databases like <span className='text-yellow-300'>MySQL</span> and non-relational databases like <span className='text-yellow-300'>MongoDB</span>. Additionally, i'm learning <span className='text-yellow-300'>Spring Boot</span>. I seek to contribute to innovative projects and continue learning in the field of web development.
                      </p>
                    }
                    {language === 'spanish' && 
                      <p className='dark:text-zinc-200 text-zinc-900 text-xs block w-full sm:text-base my-2 duration-300 text-balance'>
                        <span className='text-yellow-500 font-bold'>Desarrollador full stack</span> con <span className='text-yellow-500 font-bold'>+2 años</span> de experiencia creando aplicaciones web y APIS usando <span className='text-yellow-300'>Node.js</span>  and <span className='text-yellow-300'>React.js</span> .Tengo expreiencia creando aplicaciones REST, manejando bases de dátos relacionales como <span className='text-yellow-300'>MySQL</span> y no relacionales como <span className='text-yellow-300'>MongoDB</span>. Adicionalmente, estoy aprendiendo <span className='text-yellow-300'>Spring Boot</span>. Busco contribuir en la inovación de proyectos y continuar creciendo en el mundo del desarrollo web.
                      </p>
                    }
                  </BlurFade>
            </div>
